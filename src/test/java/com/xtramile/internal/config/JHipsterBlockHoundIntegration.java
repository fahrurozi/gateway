...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.xtramile.internal.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.xtramile.internal.security.DomainUserDetailsService", "createSpringSecurityUser");
