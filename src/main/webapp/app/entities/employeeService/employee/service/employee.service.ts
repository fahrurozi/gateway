...
type RestOf<T extends IEmployee | NewEmployee> = Omit<T, 'createdDate' | 'lastModifiedDate'> & {
...
export class EmployeeService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/employees', 'employeeservice');
