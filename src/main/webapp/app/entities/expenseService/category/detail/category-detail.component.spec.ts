...
describe('Category Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { category: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load category on init', async () => {
      ...
      // THEN
      expect(instance.category).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
});
