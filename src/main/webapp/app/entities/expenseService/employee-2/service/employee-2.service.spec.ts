...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../employee-2.test-samples';

import { Employee2Service } from './employee-2.service';

const requireRestSample: IEmployee2 = {
...
describe('Employee2 Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Employee2', () => {
      const employee2 = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(employee2).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Employee2', () => {
      const employee2 = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(employee2).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addEmployee2ToCollectionIfMissing', () => {
      it('should add a Employee2 to an empty array', () => {
        const employee2: IEmployee2 = sampleWithRequiredData;
      ...
      it("should add a Employee2 to an array that doesn't contain it", () => {
        const employee2: IEmployee2 = sampleWithRequiredData;
        const employee2Collection: IEmployee2[] = [sampleWithPartialData];
        expectedResult = service.addEmployee2ToCollectionIfMissing(employee2Collection, employee2);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(employee2);
      });
      ...
      it('should add only unique Employee2 to an array', () => {
        const employee2Array: IEmployee2[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const employee2Collection: IEmployee2[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const employee2: IEmployee2 = sampleWithRequiredData;
        const employee22: IEmployee2 = sampleWithPartialData;
    ...
    describe('compareEmployee2', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareEmployee2(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareEmployee2(entity1, entity2);
        const compareResult2 = service.compareEmployee2(entity2, entity1);
