...
import { EntityArrayResponseType, Employee2Service } from '../service/employee-2.service';
...
export class Employee2Component implements OnInit {
  ...
  trackId = (_index: number, item: IEmployee2): string => this.employee2Service.getEmployee2Identifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.employee2s = this.refineData(dataFromBody);
  }

  protected refineData(data: IEmployee2[]): IEmployee2[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IEmployee2[] | null): IEmployee2[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.employee2Service.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
