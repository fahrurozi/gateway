...
describe('Notification Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { notification: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load notification on init', async () => {
      ...
      // THEN
      expect(instance.notification).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
});
